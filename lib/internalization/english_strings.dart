...
class EnglishStrings {
  static Map<String, String> getStrings() {
    return {
      ...
      AppStrings.pleaseSelectInsuranceClass: 'Please select an insurance class',
      AppStrings.pleaseSelectProduct: 'Please select a product',
      AppStrings.pleaseSelectStartDate: 'Please select a start date',
      AppStrings.pleaseSelectEndDate: 'Please select an end date',
      AppStrings.pleaseSelectPreferredInsurer:
          'Please select a preferred insurer',
      ...
      AppStrings.vendorInsurer: 'Vendor/Insurer',
